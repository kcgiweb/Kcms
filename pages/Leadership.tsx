  ...
  const boardMembers = [
    {
      ...
      img: '/assets/images/download_3_gzxfum_abause.png'
    },
    {
      name: 'Mr. Pradeep Ramnal',
      role: 'CEO',
      tag: 'Karnataka college Group of Institutions',
      img: '/assets/images/coo_uycfyc.png'
    },
    {
      name: 'Dr. Mohd. Noor Ahmed',
      role: 'Principal',
      tag: 'Karnataka College of Management and Science',
      img: '/assets/images/IMG_4453-1152x1536_v0b6my_xvgjru.webp'
    },
  ];
